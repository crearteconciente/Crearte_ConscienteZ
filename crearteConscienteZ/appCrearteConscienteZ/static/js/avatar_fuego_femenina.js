...
document.getElementById("contenedor-3d-avatar_fuego_femenina").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarFuegoFemenina.glb", function (gltf) {
    avatar = gltf.scene;
