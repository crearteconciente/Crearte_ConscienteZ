...
document.getElementById("contenedor-3d-avatar_aire_masculino").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarAireMasculino.glb", function (gltf) {
    avatar = gltf.scene;
