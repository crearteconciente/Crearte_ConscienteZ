...
document.getElementById("contenedor-3d-avatar_tierra_masculino").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarTierraMasculino.glb", function (gltf) {
    avatar = gltf.scene;
