...
document.getElementById("contenedor-3d-avatar_agua_masculino").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarAguaMasculino.glb", function (gltf) {
    avatar = gltf.scene;
