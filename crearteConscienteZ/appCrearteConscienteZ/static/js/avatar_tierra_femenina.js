...
document.getElementById("contenedor-3d-avatar_tierra_femenina").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarTierraFemenina.glb", function (gltf) {
    avatar = gltf.scene;
