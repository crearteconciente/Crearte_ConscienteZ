...
document.getElementById("contenedor-3d-avatar_fuego_masculino").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarFuegoMasculino.glb", function (gltf) {
    avatar = gltf.scene;
