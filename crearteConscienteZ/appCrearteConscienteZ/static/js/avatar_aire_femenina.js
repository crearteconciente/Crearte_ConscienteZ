...
document.getElementById("contenedor-3d-avatar_aire_femenina").appendChild(renderer.domElement);
...
loader.load("/static/models/avatarAireFemenina.glb", function (gltf) {
    avatar = gltf.scene;
